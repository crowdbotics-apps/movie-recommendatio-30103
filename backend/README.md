...
## Project Structure
    ...
    ├── movie_recommendatio_30103  # Django project configurations
...
1. Clone this repo and `cd movie_recommendatio_30103`
...
2. Clone this repo and `cd movie_recommendatio_30103`
